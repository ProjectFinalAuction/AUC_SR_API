			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="list-group">
						...
						<div class="list-group-item">						
						  ...
						  <div class="form-group">
						    <label class="control-label col-sm-3" for="contact">Contact <sup><i class="glyphicon glyphicon-star"></i></sup></label>
						    <div class="col-sm-7">
				...
				<div class="list-group">
					...
					<div class="list-group-item">						
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="gender">Gender <sup><i class="glyphicon glyphicon-star"></i></sup></label>
					    <div class="col-sm-7">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="gender">Date of Birth <sup><i class="glyphicon glyphicon-star"></i></sup></label>
					    <div class="col-sm-7">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="gender">Address <sup><i class="glyphicon glyphicon-star"></i></sup></label>
					    <div class="col-sm-7">
