...
<div class="col-md-9" style="padding: 0;" id="right-content">
	...
	<div class="row" style="position: relative;">
		<p id="title">
			<spring:message code="new_arrival"></spring:message>
		</p>

		<!--  Loading Image -->
		<div id="myLoading">
			<img src="${pageContext.request.contextPath}/resources/static/images/loading.gif" />
		</div>
		<!--  End Loading Image -->
		...
		<div class="col-sm-6 col-md-3 product" style="padding-right: 0px;"
			...
			<div class="thumbnail" ng-repeat="proimg in a.product.gallery"
				...
				<div class="caption descript">
					...
					<p>
						<span class="price" style="margin-right: 5px;" ng-cloak>{{a.current_price
							| currency}}</span><font color="#f3809f" ng-cloak>{{a.num_bid}} </font>
