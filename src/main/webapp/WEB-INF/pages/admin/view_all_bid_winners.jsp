...
<jsp:include page="left-content.jsp"></jsp:include>
 ...
 <!-- ============================================================== -->
      ...
      <!-- ============================================================== -->                      
      <div class="content-page" ng-controller = "allBidWinners">
        <!-- Start content -->
        <div class="content">
          <div class="container">   
            <!-- Page-Title -->
                    ...
                    <table class="mails m-0 table table-actions-bar">
                    	<thead>
      						<tr>
	                           ...
	                           <th>C_Price</th>
	                           <th style="width: 236px;">B_Date</th>
	      					  <!--  <th style=" width: 192px;">Action</th> -->
							</tr>
						</thead>
  					
                      	<tbody class="body">
                        	<tr ng-repeat="b in allBidWiners | filter:str_search | orderBy:'-bid_id'">
                          		<td>
	                            ...
	                            <!--  Auction Status -->
	                            <td ng-cloak ng-if="b.auction.status=='0'" style="color:#CACFD2">inactive</td>
	                            <td ng-cloak ng-if="b.auction.status=='1'" style="color:#3498DB">active</td>
	                            <td ng-cloak ng-if="b.auction.status=='2'" style="color:#E74C3C">deleted</td>
	                            <td ng-cloak ng-if="b.auction.status=='3'" style="color:#F1C40F">completed</td>
	                            <td ng-cloak ng-if="b.auction.status=='4'" style="color:#2ECC71">checkout</td>
	                            
	                            <td ng-cloak>{{b.auction.product.product_name}}</td>
	                            <td ng-cloak>{{b.user.user_name}}</td>
	                            <td ng-cloak>{{b.user.contact}}</td>
	                            <td ng-cloak>{{b.user.email}}</td>
...
<script src="${pageContext.request.contextPath}/resources/scripts/all-bid-winners-angular.js"></script>    
