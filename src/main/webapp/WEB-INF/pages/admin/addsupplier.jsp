                  ...
                  <div class="row">                    
                    <div class="card-box">
                      ...
                      <div class="form-group clearfix">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" name="phone" id="phone" placeholder="ex : 012 99 98 99">
                        </div>
                      </div>
                      <div class="form-group clearfix">
                        <label class="col-lg-2" for="email">Email<span class="text-danger">*</span></label>
                        <div class="col-lg-10">
                          <input type="email" class="form-control" name="email" id="email" placeholder="ex :example@gmail.com">
                        </div>
                      </div><br/>
                      <div class="row">
                        <div class="col-sm-12">
