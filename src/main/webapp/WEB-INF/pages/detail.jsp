...
<div class="col-md-9" ng-controller="detailCtrl" style="padding: 0;"
	...
	<div class="container-fluid">
		...
		<div class="row" style="margin-top: -15px;">
			...
			<div class="col-md-7" style="padding-right: 0; margin-bottom: -10px;"
				id="tablebidding">
				<div class="list-group">
					<div class="list-group-item">
						<h3>{{product_name}}</h3>
		...
		<div class="row">
			...
			<div class="col-md-7" style="padding-right: 0; margin-bottom: 20px;"
				id="tablebidend">
						...
						<tbody>
							...
							<tr>
								...
								<sec:authorize access="isAuthenticated()">
									<td class="text-right"><input type="button" class="btn btn-default bidhistory" value="Bid History"
										></td>
								</sec:authorize>
							</tr>
							<tr>
